...
class Snowtricks
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="snowtricks")
     */
    private $userId;

    /**
     * @ORM\OneToMany(targetEntity=Media::class, mappedBy="snowtrickId")
     */
    private $media;
